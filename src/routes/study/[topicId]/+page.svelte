...
<div class="min-h-screen bg-white">
  ...
  <nav class="w-full border-b border-gray-200 px-6 py-3 bg-gray-50">
    <div class="max-w-7xl mx-auto">
      <div class="flex items-center text-sm text-gray-600">
        <a href="/domains" class="hover:text-black transition-colors">
          CCNA 200-301
        </a>
        <span class="mx-2">›</span>
        <a href="/domains/{getDomainNumber(topicId).split('.')[0]}" class="hover:text-black transition-colors">
          {getDomainNumber(topicId)} {getDomainName(topicId)}
        </a>
        <span class="mx-2">›</span>
  ...
  <main class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="mb-8">
      ...
      <!-- Tab Content Area -->
      <div class="bg-white rounded-lg p-8 border border-gray-200 min-h-[400px]">
        {#if activeTab === 'study'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">Study Material</h2>
            <p>Study content will go here</p>
          </div>
        {:else if activeTab === 'quiz'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">Practice Quiz</h2>
            <p>Quiz questions will go here</p>
          </div>
        {:else if activeTab === 'real-world'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">Real World Examples</h2>
            <p>Real-world examples will go here</p>
          </div>
        {:else if activeTab === 'exam-tips'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">Exam Tips</h2>
            <p>Exam tips will go here</p>
          </div>
        {:else if activeTab === 'resources'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">Resources</h2>
            <p>Links and resources will go here</p>
          </div>
        {:else if activeTab === 'commands'}
          <div class="text-gray-600">
            <h2 class="text-2xl font-bold text-black mb-4">CLI Commands</h2>
