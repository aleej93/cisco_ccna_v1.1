...
**💡 Pro Tip:** For the CCNA exam, focus on _reading_ command outputs more than memorizing exact syntax. Cisco loves to show you a `show ip route` output and ask "which route is used?"
